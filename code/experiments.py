...
###
def min_distance_drifts(name="min_distance-k=10", n_omega=60, topm=None, nr_clusters_ensemble=10, skip_drift_detection=False, skip_topm=False, skip_clustering=False, skip_type1=False, skip_type2=False):
    return dict(
            name=name,
            k=5, 
            n_omega=n_omega, 
